...
CREATE DATABASE WAIW CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE WAIW;
...
CREATE TABLE POST(
        ...
        post_pseudo         Varchar (255) NOT NULL ,
        post_movie_title    Varchar (255) NOT NULL ,
        post_movie_synopsis Text NOT NULL ,
        post_movie_director Varchar (255) NOT NULL ,
        post_movie_actors   Varchar (255) NOT NULL ,
        post_movie_release  Date NOT NULL ,
        post_movie_poster   Varchar (255) DEFAULT NULL ,
